...
type Config struct {
	...
	// InsecureEnableGroups enables groups claims. This is disabled by default until https://github.com/briancabbott/dex/issues/1065 is resolved
...
var brokenAuthHeaderDomains = []string{
	// See: https://github.com/briancabbott/dex/issues/859
	"okta.com",
	"oktapreview.com",
}
